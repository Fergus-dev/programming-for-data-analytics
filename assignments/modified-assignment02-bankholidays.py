...
# cross reference data frames to find bank holidays unique to Northern Ireland
# Copilot conversation for reference: https://copilot.microsoft.com/shares/wMh5d19vqpjtsBuyaonvQ
# So the following code in English says, create a new data frame from whatever data that is in the events column of the norther ireland
